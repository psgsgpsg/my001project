...
public:
	...
	SapXferPairInfo(SapXferPair &pair, int index, SapTransfer *pXfer) 
		{ m_Pair = pair; m_Pair.m_Xfer = pXfer; m_Index = index; m_pXfer = pXfer; m_context = NULL; }
