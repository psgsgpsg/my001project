...
#define CORSTATUS_DEVICE_NOT_CONNECTED       0x7F  // Device is not connected, unplugged.
#define CORSTATUS_RESOURCE_ACCESS            0x80  // Resource is not accessible. 
#define CORSTATUS_DEVICE_NOT_RESPONDING      0x81  // Remote device is not responding.
#define CORSTATUS_DATA_INVALID               0x82  // Data expected is invalid.
#define CORSTATUS_RESOURCE_READ              0x83  // Error reading from resource.
#define CORSTATUS_RESOURCE_WRITE             0x84  // Error writing to resource     
#define CORSTATUS_CONNECTION_DROPPED         0x85  // Logical connection with device was lost.
#define CORSTATUS_EVALUATION_PERIOD_EXPIRED  0x86  // Sapera LT evaluation period has expired
