...
#define CORMAN_VAL_EVENT_TYPE_SERVER_NOT_ACCESSIBLE   0x00000002
#define CORMAN_VAL_EVENT_TYPE_SERVER_ACCESSIBLE       0x00000004
...
#define CORMAN_VAL_EVENT_TYPE_MASK                    0x0000000f
...
CORSTATUS CORAPIFUNC CorManCallbackEx( CORSERVER hServer, PCOREVENTINFOCALLBACK callback, void *context, UINT32 callbackType, PCALLBACK_EXTRA_INFO extraInfo, PUINT32 eventIndexBuf, void *customBuf);
