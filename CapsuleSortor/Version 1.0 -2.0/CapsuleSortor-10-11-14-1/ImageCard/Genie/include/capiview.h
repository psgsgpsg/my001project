...
// mask certain bits from VIEWing
...
/*------------------------------------------------------------------------*/
// Weather no tearing mechanism in this view
...
//Alpha keying modes supported
#define CORVIEW_CAP_ALPHA_KEY_MODE					CORVIEW_CAP( 30, 4)

//step that will cause a change in the alpha blending factor
...
/*-----------------------------------------------------------------------*/
// Turn on mechanism to prevent tearing on this display	
