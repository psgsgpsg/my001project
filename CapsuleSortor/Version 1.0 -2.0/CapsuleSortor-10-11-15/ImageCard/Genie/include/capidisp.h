...
/*------------------------------------------------------------------------*/
// color space of the display device
...
/*------------------------------------------------------------------------*/
// Brightness Control Supported FALSE/TRUE 
#define  CORDISPLAY_CAP_BRIGHTNESS                 CORDISPLAY_CAP( 2, 4)
// Minimum for BRIGHTNESS 
...
// Step value for CONTRAST  
#define  CORDISPLAY_CAP_CONTRAST_STEP				   CORDISPLAY_CAP( 9, 4)
/*------------------------------------------------------------------------*/
// Saturation Control Supported FALSE/TRUE 
...
// Step value for SATURATION                                                          
#define  CORDISPLAY_CAP_SATURATION_STEP				CORDISPLAY_CAP(13, 4)
/*------------------------------------------------------------------------*/
// Hue Control	Supported FALSE/TRUE 
...
/*------------------------------------------------------------------------*/
// zooming for the whole display plane
...
/*------------------------------------------------------------------------*/
// left edge of DISPLAY must be aligned every X bits relative to source buffer origin
#define  CORDISPLAY_CAP_ALIGN_LEFT                 CORDISPLAY_CAP(34, 4)
// top edge of DISPLAY must be aligned  every Y bits relative to source buffer origin
#define  CORDISPLAY_CAP_ALIGN_TOP                  CORDISPLAY_CAP(35, 4)
// width of DISPLAYed region must be a multiple of X bits                            
#define  CORDISPLAY_CAP_ALIGN_WIDTH                CORDISPLAY_CAP(36, 4)
// width of DISPLAYed region must be a multiple of Y bits                            
#define  CORDISPLAY_CAP_ALIGN_HEIGHT               CORDISPLAY_CAP(37, 4)
// stride of DISPLAY must be a multiple of Y bits                                    
...
/*------------------------------------------------------------------------*/
// Scale image width to this pixel size 
#define  CORDISPLAY_PRM_ZOOM_HORZ						CORDISPLAY_PRM( 4, 4)
/*------------------------------------------------------------------------*/
// Scale image height to this pixel size 
...
/*------------------------------------------------------------------------*/
// Linear/physical address of display memory
...
/*------------------------------------------------------------------------*/
// Buffer format corresponding to display depth
