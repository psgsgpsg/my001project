...
public:
   ...
   SapFormatType GetType() { return m_Type; }
...
public:
   ...
   SapDataMono(const SapData &data)
      { m_Type = SapFormatTypeMono; m_Data = data.m_Data; }

   SapDataMono &operator=(const SapData &data) { m_Type = SapFormatTypeMono; m_Data = data.m_Data; return *this; }
...
public:
   ...
   SapDataRGBA(const SapData &data)
      { m_Type = SapFormatTypeRGBA; m_Data = data.m_Data; }

   SapDataRGBA &operator=(const SapData &data) { m_Type = SapFormatTypeRGBA; m_Data = data.m_Data; return *this; }
...
public:
   ...
   SapDataRGB(const SapData &data)
      { m_Type = SapFormatTypeRGB; m_Data = data.m_Data; }

   SapDataRGB &operator=(const SapData &data) { m_Type = SapFormatTypeRGB; m_Data = data.m_Data; return *this; }
