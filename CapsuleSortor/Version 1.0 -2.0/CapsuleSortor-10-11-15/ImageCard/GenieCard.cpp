...
bool GenieCard::CreateObjects()
{
	...
	{
		BOOL ok = m_acqDevice->SetConfigFile("Camera Configurtion 1");
...
bool GenieCard::Open	(const char * camTag)					//open the card
{
	return Open();
}
