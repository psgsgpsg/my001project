...
# ADD CPP /nologo /MD /W3 /GX /O2 /Ob2 /I "../ToolCVB" /I "../ToolCVB/Include" /I "../Valve" /I "../Remain" /I "../CapsuleSorter" /I "../ImageCard" /I "../ToolSrc" /I "../ImageCard/SVSGigE\include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /D "COLOR_ORDER_RGB" /D "NEW_REMAIN" /Fr /YX /FD /EHa /c
