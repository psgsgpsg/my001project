...
#define CORCAM_VAL_FRAME_PROGRESSIVE		CORACQ_VAL_FRAME_PROGESSIVE
...
#define CORCAM_VAL_LINESCAN_DIRECTION_FORWARD CORACQ_VAL_LINESCAN_DIRECTION_FORWARD 
#define CORCAM_VAL_LINESCAN_DIRECTION_REVERSE CORACQ_VAL_LINESCAN_DIRECTION_REVERSE 
...
#define CORCAM_VAL_CONNECTOR_TYPE_LVDS 		CORACQ_VAL_CONNECTOR_TYPE_LVDS
