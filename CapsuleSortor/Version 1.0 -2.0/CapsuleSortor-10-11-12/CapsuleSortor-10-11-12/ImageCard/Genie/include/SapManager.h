...
public:
   ...
   enum _ServerType
   {
      ...
      ServerX64CLiPROe   = CORPORT_X64IPROE,
...
public:
   ...
   // Internal usage only
   BOOL InternalCommand(int serverIndex, int command, void *inData, int inDataSize, void *outData, int outDataSize);
...
public:
   ...
   {
      Construct(SapManager::EventNone, serverIndex, 0, context, SapManager::StatusOk, NULL);
   }
   SapManCallbackInfo(SapManager::EventType eventType, int serverIndex, void *context)
   {
      Construct(eventType, serverIndex, 0, context, SapManager::StatusOk, NULL);
   }
   SapManCallbackInfo(SapManager::EventType eventType, int serverIndex, int resourceIndex, void *context)
   {
      Construct(eventType, serverIndex, resourceIndex, context, SapManager::StatusOk, NULL);
   }
   SapManCallbackInfo(SAPSTATUS errorValue, const char *errorMessage, void *context)
   {
      Construct(SapManager::EventNone, 0, 0, context, errorValue, errorMessage);
   }
   ~SapManCallbackInfo() {}
...
protected:
   void Construct(SapManager::EventType eventType, int serverIndex, int resourceIndex, void *context, SAPSTATUS errorValue, const char *errorMessage)
   {
