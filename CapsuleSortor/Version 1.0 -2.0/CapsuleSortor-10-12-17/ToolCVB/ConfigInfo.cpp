									...
									TIniFile::EnumPath	ePath)
{
	...
	m_packageCapablity = TIniFile::GetInt("SysConfig",		"PKGCapablity",	0);
							 ...
							 TIniFile::EnumPath	ePath)
{
	...
	TIniFile::GetInt("SysConfig",		"WorkMode",			m_workMode);
	TIniFile::GetInt("SysConfig",		"Solution_X",		m_solution_X);
	TIniFile::GetInt("SysConfig",		"Solution_Y",		m_solution_Y);
	TIniFile::SetInt("SysConfig",		"PKGCapablity",		m_packageCapablity);
...
const int	ConfigInfo::PKGCapability	()const
{
	return m_packageCapablity;
}