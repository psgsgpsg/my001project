...
void CCamConfigSetting::ProciProcess(void *param)
{
	CCamConfigSetting* pThis = (CCamConfigSetting*)(param);
	{
		...
		while (1)
		{
			...
			pThis->m_prociToProci = (reinterpret_cast<SVSGigECard *>(pThis->m_FirstCard))->FrameInterval();
...
void CCamConfigSetting::GenieProcess(void *param)
{
	...
	while (1)
	{
		pThis->m_genieToGenie = (reinterpret_cast<SVSGigECard *>(pThis->m_SecondCard))->FrameInterval();
...
void CCamConfigSetting::OnSetColorcam() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
//	m_FirstCard->SetROI			(m_colorROIStartX , m_colorROIStartY , m_colorROIWidth, m_colorROIHeight);
...
void CCamConfigSetting::OnSetMonocam() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
//	m_SecondCard->SetROI		(m_monoROIStartX , m_monoROIStartY , m_monoROIWidth, m_monoROIHeight);
